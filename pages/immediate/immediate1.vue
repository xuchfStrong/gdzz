      ...
      <view v-show="currentTab === 0">
        <view class="attr-flex">
          ...
          <view class="attr-flex-item">
            <uni-number-box :value="attackTime.bossTime" @change="changeNumberInput($event,'tuituBoss')"></uni-number-box>
          </view>
        ...
        <view class="attr-flex">
          ...
          <view class="attr-flex-item">
            <uni-number-box :value="attackTime.xiaoguaiTime" @change="changeNumberInput($event,'xiaoguai')"></uni-number-box>
          </view>
          <view class="attr-flex-item-button">
        ...
        <view class="attr-flex">
          ...
          <view class="attr-flex-item">
            <uni-number-box :value="attackTime.wujinTime" @change="changeNumberInput($event,'wujin')"></uni-number-box>
          </view>
          <view class="attr-flex-item-button">
